...
func init() {
	...
	beego.GlobalControllerRouter["hojasdevida/controllers:CategoriaPersonaController"] = append(beego.GlobalControllerRouter["hojasdevida/controllers:CategoriaPersonaController"],
	...
	beego.GlobalControllerRouter["hojasdevida/controllers:TipoCategoriaController"] = append(beego.GlobalControllerRouter["hojasdevida/controllers:TipoCategoriaController"],
		beego.ControllerComments{
			Method: "Post",
			Router: `/`,
			AllowHTTPMethods: []string{"post"},
