...
func init() {
	...
	beego.GlobalControllerRouter["kyronApi/controllers:CategoriaPersonaController"] = append(beego.GlobalControllerRouter["kyronApi/controllers:CategoriaPersonaController"],
	...
	beego.GlobalControllerRouter["kyronApi/controllers:TipoCategoriaController"] = append(beego.GlobalControllerRouter["kyronApi/controllers:TipoCategoriaController"],
		beego.ControllerComments{
			Method: "Post",
			Router: `/`,
			AllowHTTPMethods: []string{"post"},
